...
//
//
//    private void showBookDetailsOnline(JsonObject book) {
//        if (book != null) {
//            JsonObject volumeInfo = book.has("volumeInfo") ? book.getAsJsonObject("volumeInfo") : null;
//
//            Text bookTitle = null;
//            Text bookAuthor = null;
//            Text bookDescription = null;
//            Text bookPages = null;
//            Text bookPublishedDate = null;
//            Text bookPublisher = null;
...
//
//                // Set number of pages
//                bookPages.setText(volumeInfo.has("pageCount") ?
//                        volumeInfo.get("pageCount").getAsString() + " pages" : "Page count not available");
//
//                // Set published date
//                bookPublishedDate.setText(volumeInfo.has("publishedDate") ?
//                        "Published Date: " + volumeInfo.get("publishedDate").getAsString()
//                        : "Published Date: N/A");
//
//                // Set publisher information
//                bookPublisher.setText(volumeInfo.has("publisher") ?
//                        "Publisher: " + volumeInfo.get("publisher").getAsString() : "Publisher: Unknown");
//
...
//                }
//            } else {
//                // Clear fields if no volume info is found
...
//                bookCover.setImage(null); // Clear image
//            }
//        } else {
//            System.out.println("Book object is null!"); // For debugging
//        }
//    }
//
//
